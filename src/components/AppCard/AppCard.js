      ...
      <div className={styles.cardLayout}>
        ...
        <div className={styles.contentSection}>
          <div className={styles.header}>
            <h3 id={`app-name-${app.id}`} className={styles.appName}>{app.name}</h3>
            ...
            <div className={styles.storeButtons}>
              {app.appStoreUrl && (
                <a 
                  ...
                  onClick={() => trackAppDownload(app.name, 'app_store', app.appStoreUrl)}
                >
                  <svg className={styles.storeIcon} viewBox="0 0 24 24" fill="currentColor" aria-hidden="true">
              ...
              {app.playStoreUrl && (
                <a 
                  ...
                  onClick={() => trackAppDownload(app.name, 'play_store', app.playStoreUrl)}
                >
                  <svg className={styles.storeIcon} viewBox="0 0 24 24" fill="currentColor" aria-hidden="true">
